...
public class MemberJpaRepository {
    ...
    /**
     * 각각의 클라이언트들으 서비스를 이용할때 entitymanager를 싱글톤으로 사용하게되는데
     * 싱글톤이라면 모든클라이언트들이 하나의 엔티티매니저를 쓰는것처럼 생각하지만
     ...
     * 일반적으로 사용됩니다. 예를 들어, JDBC DataSource 또한 비슷한 방식으로 작동하는데, 싱글톤 DataSource 빈은 실제로는 커넥션 풀을 관리하며, 각 트랜잭션은 이 커넥션 풀로부터 독립된 DB 커넥션을 얻게 됩니다.
     */
