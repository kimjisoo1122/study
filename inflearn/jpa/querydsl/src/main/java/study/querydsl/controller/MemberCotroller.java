...
import study.querydsl.repositroy.MemberJpaRepository;
...
public class MemberCotroller {
    ...
    public List<MemberTeamDTO> searchMembersV1(MemberSearchCondition searchCondition) {
        return memberJpaRepository.findMemberTeamDTO(searchCondition);
    }
